...
static const uint8_t RCON[51] PROGMEM = {
...
static const uint8_t S_BOX[256] PROGMEM = {
...
static const uint8_t INV_S_BOX[256] PROGMEM = {
...
static uint8_t Rcon(const uint8_t in_I) {
  return pgm_read_byte_near(&RCON[in_I % 51]);
}



static uint8_t sBox(const uint8_t in_X) {
  return pgm_read_byte_near(&S_BOX[in_X]);
}



static uint8_t invSBox(const uint8_t in_X) {
  return pgm_read_byte_near(&INV_S_BOX[in_X]);
}
