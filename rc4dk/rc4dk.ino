//#include "rc4dk_plain.h" // 3719 ms   4146 flash    262 ram
//#include "rc4dk_opt.h"   // 3719 ms   4146 flash    262 ram
//#include "rc4dk_nop.h"   //   30 ms   3534 flash    262 ram
...
void setup() {
  ...
  puts((char *)in);
  rc4dEncrypt(out, in, inLen, key);
  printHex(out, inLen);
  rc4dDecrypt(in, out, inLen, key);
  puts((char *)in);
  ...
  rc4dEncrypt(out2, in2, in2Len, key2);
  ...
  for (uint16_t i = 0; i < 1024; i++) {
    rc4dEncrypt(out2, in2, in2Len, key2);
    rc4dDecrypt(in2, out2, in2Len, key2);
  }
