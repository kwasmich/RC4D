//#include "rc4d_plain.h" // 17619 ms   4640 flash    262 ram
//#include "rc4d_opt.h"   //  9054 ms   4234 flash    262 ram
//#include "rc4d_nop.h"   //    31 ms   3560 flash    262 ram
...
void setup() {
  ...
  puts((char *)in);
  rc4dEncrypt(out, in, inLen, key, keyLen);
  printHex(out, inLen);
  rc4dDecrypt(in, out, inLen, key, keyLen);
  puts((char *)in);
  ...
  rc4dEncrypt(out2, in2, in2Len, key2, key2Len);
  ...
  for (uint16_t i = 0; i < 1024; i++) {
    rc4dEncrypt(out2, in2, in2Len, key2, key2Len);
    rc4dDecrypt(in2, out2, in2Len, key2, key2Len);
  }
